	...
	if cm:is_multiplayer() == false then
		...
		if cm:is_new_game() then
			...
			if faction_name == JOCHI_KEY then
				mkDecisions:Add_Decision("form_empire_golden_horde", faction_name, false, true);
			end
		end
	end
end
...
function Golden_Horde_Regions_Check(context)
	...
	if has_regions == true then
		...
		elseif (not mkHRE or (mkHRE and table.HasValue(mkHRE.factions, faction_name) ~= true)) then
			mkDecisions:Enable_Decision("form_empire_golden_horde");
		end	
	end
end
...
function Golden_Horde_Formed(faction_name)
	...
	if cm:is_multiplayer() == false then
		mkDecisions:Remove_Decision("form_empire_golden_horde");
	end
