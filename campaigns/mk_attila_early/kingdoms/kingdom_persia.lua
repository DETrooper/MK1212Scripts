	...
	if cm:is_multiplayer() == false then
		...
		if cm:is_new_game() then
			...
			if faction_name == GHURIDS_KEY or faction_name == HAZARASPIDS_KEY or faction_name == ILDEGIZIDS_KEY or faction_name == SALGHURIDS_KEY then
				mkDecisions:Add_Decision("form_empire_persia", faction_name, false, true);
			end
		end
	end
end
...
function Persian_Empire_Regions_Check(context)
	...
	if has_regions == true then
		...
		elseif (not mkHRE or (mkHRE and table.HasValue(mkHRE.factions, faction_name) ~= true)) then
			mkDecisions:Enable_Decision("form_empire_persia");
		end		
	end
end
...
function Persian_Empire_Formed(faction_name)
	...
	if cm:is_multiplayer() == false then
		mkDecisions:Remove_Decision("form_empire_persia");
