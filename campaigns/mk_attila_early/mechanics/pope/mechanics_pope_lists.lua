...
JERUSALEM_REGION_KEY = "mk_reg_jerusalem";
...
SCRIPTED_CRUSADES_LIST = {
	...
	["5"] = {"mk_reg_cairo", 7, 11, "mk_mission_crusades_take_cairo_fifth_crusade", "mk_mission_crusades_defense_cairo", {"mk_fact_france", "mk_fact_hre", "mk_fact_hungary", "mk_fact_jerusalem"}}
}
...
CRUSADE_REGIONS = {
	...
	["mk_reg_rome"] = 10000, -- Rome
	["mk_reg_toulouse"] = 2500, -- Toulouse
	["mk_reg_london"] = 2500, -- London
	["mk_reg_frankfurt"] = 2500, -- Frankfurt
	["mk_reg_toledo"] = 2500, -- Toledo
	["mk_reg_paris"] = 2500, -- Paris
	["mk_reg_barcelona"] = 2500, -- Barcelona
	-- Orthodox territories to be reconquered if lost to non-Christians.
	["mk_reg_constantinopolis"] = 2000, -- Constantinople
	["mk_reg_thessalonica"] = 1500, -- Thessalonica
	-- Important Middle East territories.
	["mk_reg_jerusalem"] = 1000, -- Jerusalem
	["mk_reg_antioch"] = 500, -- Antioch
	["mk_reg_cairo"] = 500, -- Cairo
	["mk_reg_cordoba"] = 500, -- Cordoba
	["mk_reg_acre"] = 250, -- Acre
	["mk_reg_alexandria"] = 250, -- Alexandria
	["mk_reg_damietta"] = 250, -- Damietta
	["mk_reg_tripoli_levant"] = 250, -- Tripoli
	["mk_reg_tunis"] = 250, -- Tunis
	["mk_reg_damascus"] = 100,
}
