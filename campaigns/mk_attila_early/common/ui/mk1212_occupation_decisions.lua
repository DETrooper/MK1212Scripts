	...
	if context.string == "settlement_captured" then
		...
		if occupation_decision_occupy_uic and occupation_decision_occupy_uic:Visible() then
			...
			for i = 0, faction_list:num_items() - 1 do
				...
				elseif (vassal_tracking_enabled and table.HasValue(FACTIONS_TO_FACTIONS_VASSALIZED[human_faction_name], current_faction_name)) then
			...
			for i = 1, #valid_allies do
				...
				if table.HasValue(FACTIONS_WITH_IMAGES, ally_name) then
			...
			for i = 1, #valid_vassals do
				...
				if table.HasValue(FACTIONS_WITH_IMAGES, vassal_name) then
