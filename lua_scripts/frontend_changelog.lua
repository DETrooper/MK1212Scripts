...
local changelogstring = 	"Welcome to the MK1212 Campaign Open Alpha!\n\n"..
			"This update brings a wealth of new units, reworked rosters, and new playable factions in custom battles. Exciting new additions include cannon elephants, trebuchet artillery, and significantly larger battlefields. Several major bugs have also been fixed, such as the limit on the number of units per faction (though this comes at the cost of AI-generated armies in custom battles) and the infamous replay bug. Lastly, there has been major rebalancing overall, as well as improvements to how the AI uses certain units such as cavalry.\n\n"..
