...
function CreateScriptDisclaimer()
	...
	disclaimer_uic:CreateComponent("disclaimer_accept", "UI/new/basic_toggle_accept");

	local disclaimer_accept_uic = UIComponent(disclaimer_uic:Find("disclaimer_accept"));
